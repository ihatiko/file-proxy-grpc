...
type FileService_UploadFileClient interface {
	Send(*UploadFileInfoRequest) error
...
func (x *fileServiceUploadFileClient) Send(m *UploadFileInfoRequest) error {
...
type FileService_UploadFileServer interface {
	...
	Recv() (*UploadFileInfoRequest, error)
	grpc.ServerStream
}
...
func (x *fileServiceUploadFileServer) Recv() (*UploadFileInfoRequest, error) {
	m := new(UploadFileInfoRequest)
